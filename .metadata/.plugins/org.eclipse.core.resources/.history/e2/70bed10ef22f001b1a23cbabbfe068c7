...
public class Main extends Application{
	...
	public void start(Stage primaryStage) throws Exception {
		...
		loginScene = new Scene(cenaLogin, 550, 400);
	...
	public static void changeScene(String scr) {
		...
		case "main":
			stage.close();
			stage.setTitle("Sistema de Máquinas");
 ...
 * 
 * Label ultInspecM = new Label("M - Ultima Inspeção:");
 * ultInspecM.getStyleClass().add("spaceLeft"); TextField textInspecM = new
 * TextField(); textInspecM.setDisable(true);
 * 
 * Label ultInspecA = new Label("A - Ultima Inspeção:"); TextField textInspecA =
 ...
 * primaryStage.setTitle("Gestão de Máquinas");
